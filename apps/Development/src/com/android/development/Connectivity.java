...
public class Connectivity extends Activity {
   ...
   /**
    ...
    private static class DevToolsEthListener implements EthernetManager.Listener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mEm.addListener(mEthListener, this::runOnUiThread);
    }
    ...
    public void onDestroy() {
        ...
        mCm.unregisterNetworkCallback(mCallback);
        mCallback = null;
        mEm.removeListener(mEthListener);
