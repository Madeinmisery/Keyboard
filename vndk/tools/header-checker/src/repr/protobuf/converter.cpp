...
abi_diff::RecordTypeDiff IRDiffToProtobufConverter::ConvertRecordTypeDiffIR(
  ...
  record_type_diff_protobuf.set_linker_set_key(record_type_diff_ir->GetLinkerSetKey());
...
abi_diff::EnumTypeDiff IRDiffToProtobufConverter::ConvertEnumTypeDiffIR(
  ...
  enum_type_diff_protobuf.set_linker_set_key(enum_type_diff_ir->GetLinkerSetKey());
