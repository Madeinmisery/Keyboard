...
def _parse_args():
    ...
    parser.add_argument('--lib', dest='libs', metavar="LIB", action='append',
                        help='libs to create references for')
    parser.add_argument('--product', dest='products', metavar="PRODUCT",
                        action='append',
    ...
    # Old docuemnts refer to these single-dash arguments.
    parser.add_argument('-libs', action='append', help=argparse.SUPPRESS)
    parser.add_argument('-products', action='append', help=argparse.SUPPRESS)
    parser.add_argument('-release', help=argparse.SUPPRESS)
    parser.add_argument('-ref-dump-dir', help=argparse.SUPPRESS)
