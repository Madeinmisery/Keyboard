...
def create_source_abi_reference_dumps(args, get_ref_dump_dir_stem, lsdump_paths, targets):
    ...
    for target in targets:
        ...
        num_libs_copied += find_and_copy_lib_lsdumps(
            get_ref_dump_dir_stem, target, args.libs, lsdump_paths, args.compress)
...
def create_source_abi_reference_dumps_for_all_products(args):
    ...
    for product in args.products:
        ...
        get_ref_dump_dir_stem = GetRefDumpDirStem(args.ref_dump_dir, chosen_vndk_version,
        ...
        num_processed += create_source_abi_reference_dumps(args, get_ref_dump_dir_stem,
