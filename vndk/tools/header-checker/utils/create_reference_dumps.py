...
def get_ref_dump_dir_stem(ref_dump_dir, category, chosen_vndk_version,
    ...
    return os.path.join(ref_dump_dir, category, version,
                        binder_bitness, arch)
...
def create_source_abi_reference_dumps_for_all_products(args):
    ...
    for product in args.products:
        ...
        # chosen_vndk_version is expected to be the finalized PLATFORM_SDK_VERSION if the codename is REL.
        chosen_platform_version = chosen_vndk_version if platform_version_codename == 'REL' else 'current'
