...
class SuperImageRepacker:
  ...
  def unsparse_super_img(self):
    ...
    with tempfile.NamedTemporaryFile(
      ...
      raw_super_img_path = raw_super_img.name
      self.temp_files.append(raw_super_img_path)
      subprocess.check_call(
          [simg2img_path, self.super_img, raw_super_img_path])
    return raw_super_img_path
  ...
  def create_misc_info(self, org_misc_info, args_part_imgs,
    ...
    with tempfile.NamedTemporaryFile(
      ...
      self.temp_files.append(misc_info_file_path)
