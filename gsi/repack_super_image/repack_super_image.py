...
def repack_super_image(ota_tools_dir, misc_info_path, super_img_path,
  ...
  try:
    if not is_sparse_image(super_img_path):
      unsparsed_super_img = super_img_path
    else:
      ...
      with tempfile.NamedTemporaryFile(
        ...
        unsparsed_super_img = raw_super_img.name
        subprocess.check_call([
            simg2img_path, super_img_path, unsparsed_super_img])
    ...
    subprocess.check_call([lpunpack_path, unsparsed_super_img, unpack_dir])
