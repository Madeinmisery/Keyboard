...
class TestParse(unittest.TestCase):
  ...
  def test_one_way(self):
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      self.assertEqual(filecmp.cmp('testdata/compare/one_way_diff.csv', csvfile), True)
  ...
  def test_two_way(self):
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      self.assertEqual(filecmp.cmp('testdata/compare/two_way_diff.csv', csvfile), True)
  ...
  def test_n_way(self):
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      self.assertEqual(filecmp.cmp('testdata/compare/n_way_diff.csv', csvfile), True)
