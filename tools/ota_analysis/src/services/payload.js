...
class OTAPayloadBlobWriter extends zip.Writer {
  ...
  async writeUint8Array(/**  @type {Uint8Array} */ array) {
    ...
    // Once the prefixLength is non-zero, the adress of manifest and signature
    ...
    if (this.prefixLength > 0) {
      ...
      this.prefixLength = _PAYLOAD_HEADER_SIZE + this.payload.manifest_len + this.payload.metadata_signature_len
      return
    }
