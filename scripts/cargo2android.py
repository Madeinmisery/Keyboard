...
class Crate(object):
  ...
  def dump_one_android_module(self, crate_type):
    ...
    if self.runner.variant_args.min_sdk_version and crate_type in LIBRARY_CRATE_TYPES:
  ...
  def decide_one_module_type(self, crate_type):
    ...
    if crate_type == 'bin':  # rust_binary[_host]
      ...
      self.stem = altered_stem(self.crate_name) + self.runner.variant_args.suffix
      self.module_name = altered_name(self.stem)
      ...
      self.stem = 'lib' + self.crate_name + self.runner.variant_args.suffix
      self.module_name = altered_name(self.stem)
...
class Runner(object):
  ...
  def run_cargo(self):
    ...
    for variant_num in range(num_variants):
      ...
      self.variant_args = argparse.Namespace(**vars(self.args) | self.args.variants[variant_num])
