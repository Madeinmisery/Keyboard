...
class Crate(object):
  ...
  def test_module_name(self):
    ...
    device_host = ''
    if self.device_supported and not self.host_supported:
      device_host = '_device'
    elif self.host_supported and not self.device_supported:
      device_host = '_host'
    return self.root_pkg + device_host + '_test_' + suffix
