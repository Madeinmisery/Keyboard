...
from typing import BinaryIO, Any, Dict, Union
...
def merge_launch_dict(base: Dict[str, Any], to_add:  Union[Dict[str, Any], None]) -> None:
...
def generate_vscode_lldb_script(root: str, sysroot: str, binary_name: str, port: str | int, solib_search_path: list[str], extra_props: Union[Dict[str, Any], None]) -> str:
...
def generate_setup_script(sysroot: str, linker_search_dir: str | None, binary_name: str, is64bit: bool, port: str | int, debugger: str, vscode_launch_props: Union[Dict[str, Any], None]) -> str:
